...
import com.kadampa.GluonApplication;
...
public class AppViewManager {
    ...
    public static final AppView PRIMARY_VIEW = view("Home", PrimaryPresenter.class, MaterialDesignIcon.HOME, SHOW_IN_DRAWER, HOME_VIEW, SKIP_VIEW_STACK);
    public static final AppView SECONDARY_VIEW = view("Events", SecondaryPresenter.class, MaterialDesignIcon.DASHBOARD, SHOW_IN_DRAWER);
    ...
    public static void registerViewsAndDrawer() {
        ...
        NavigationDrawer.Header header = new NavigationDrawer.Header("KBS3 Application",
                "Kadampa Booking Project",
